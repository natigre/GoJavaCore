...
public class TripAdvisorBaseApi implements BaseApi {

    private Room[] rooms = new Room[5];

    public TripAdvisorBaseApi() {
        Date date = new Date();
        rooms[0] = new Room(23, 270, 1, date, "Druzhba", "Krivij Rih");
        rooms[1] = new Room(14, 420, 1, date, "West", "Krivij Rih");
